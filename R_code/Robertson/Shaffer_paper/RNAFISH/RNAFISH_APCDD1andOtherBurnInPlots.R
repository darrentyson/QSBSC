...
dataNoDrug <- read.csv(file = 'dentistData/burnInGenes/20161023_WM9_noDrug_burnIns.txt')
dataNoDrug$condition <- 'noDrug'
# How many cells?
dim(dataNoDrug)

dataResistant <- read.csv(file = 'dentistData/burnInGenes/20161026_WM9_ResistantB2_2_BurnIn_Pool1.txt')
...
dataNoDrug <- read.csv(file = 'dentistData/burnInGenes/20161103_noDrug_pool1burnIn_replicates.txt')
dataNoDrug$condition <- 'noDrug'
dim(dataNoDrug)

dataResistant <- read.csv(file = 'dentistData/burnInGenes/20161108_WM9_resistant_burnIn_replicates.txt')
dataResistant$condition <- 'resistant line'
dim(dataResistant)
...
dataNoDrug <- read.csv('dentistData/20160727_WM9noDrug_BurnIn.txt')
dataNoDrug$condition <- 'noDrug'

# TXNRD1 in a sample with drug for 4 weeks:
dataResistant <- read.csv(file = 'dentistData/burnInGenes/20161004_WM9_week4_TXNRD1.txt')
...
dataResistant <- read.csv(file = 'dentistData/burnInGenes/20161109_WM9_resistant_TXNRD1.txt')
