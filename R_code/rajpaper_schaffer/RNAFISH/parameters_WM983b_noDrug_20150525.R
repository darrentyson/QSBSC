...
# SERPINE1 Atto700 - weird data set because I think the cells with the highest number of spots are real, but can’t say about  -- I think this data may have the old nir problem.
