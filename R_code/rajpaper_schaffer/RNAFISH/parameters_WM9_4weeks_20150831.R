# parameters file for WM9 4 weeks drug 20150831

load_WM9_4weeks_20150831 <- function(){
  # define directories
  plotDir <- plotDir
  
  # this will be the begining of the name for every plot generated by this script
  plotName <- 'WM9_4weeks_20150831'
  
  # Load data 
  data <- read.csv('/Users/paudelbb/Downloads/rajpaper/dentistData/WM9_4weeks_20150831.txt')
  ...
  WM9_4weeks_20150831 <- list(plotName,plotDir,data,thresholds)
  return(WM9_4weeks_20150831)
}

load_WM9_4weeks_20150831_colonyAnnotations <- function(){
  ...
  # Load data 
  data <- read.csv('/Users/paudelbb/Downloads/dentistData/WM9_4weeks_20150831_clusterAnnotations.txt')
