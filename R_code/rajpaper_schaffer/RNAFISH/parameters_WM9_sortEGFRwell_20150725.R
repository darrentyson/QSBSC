# parameters file for WM9 sort EGFR well

load_WM9_sortEGFRwell_20150725 <- function(){
  # define directories
  plotDir <- plotDir
  ...
  WM9_sortEGFRwell_20150725 <- list(plotName,plotDir,data,thresholds)
  return(WM9_sortEGFRwell_20150725)
}
