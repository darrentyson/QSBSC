...
load_WM9_48hrs_20150624 <- function(percentileForThresholds){
  ...
  # Load data 
  data <- read.csv('/Users/paudelbb/Downloads/rajpaper/dentistData/WM9_48hrs_20150624.txt')
...
## Maggie's notes
# Hyb 1:
#   Alexa - cleaned down through 5 spots. Don’t threshold below 5. Accidently changed threshold, then changed it back as close as possible and rechecked. Still the same cells/spots.
